<template>
	<!-- START STAKES CARDS -->
	<div class="columns has-text-centered" v-waypoint="{ active: true, callback: onBountyViewStatsWaypoint }">
		<div class="column is-one-quarter">
			<div class="box is-v-centered">
				<h2 class="is-bold is-size-1">
					<span class="my-stakes-odometer" data-my-stakes="10125">10,125</span>
				</h2>
		...
		<div class="column is-one-quarter">
			<div class="box is-v-centered">
				<h2 class="is-bold is-size-1">
					<span class="distributed-stakes-odometer" data-distributed-stakes="290,100">290,100</span>
				</h2>
				<hr style="margin-top: 8px;" />
		...
		<div class="column is-one-quarter">
			<div class="box is-v-centered">
				<h2 class="is-bold is-size-1">
					<span class="pending-reward-odometer" data-pending-reward="56500">56,500</span>
				</h2>
				<hr style="margin-top: 8px;" />
		...
		<div class="column is-one-quarter">
			<div class="box is-v-centered">
				<h2 class="is-bold is-size-1">
					<span class="prize-share-odometer" data-prize-share="27">27</span>%
				</h2>
				<hr style="margin-top: 8px;" />
